...
#       var(ttr, 'tau_againstE0Cat')
       ...
       ## RM new TauIDs
       var(ttr, 'tau_byIsolationMVA3oldDMwoLTraw'    )
       var(ttr, 'tau_byLooseIsolationMVA3oldDMwoLT'  )
       var(ttr, 'tau_byMediumIsolationMVA3oldDMwoLT' )
       var(ttr, 'tau_byTightIsolationMVA3oldDMwoLT'  )
       var(ttr, 'tau_byVTightIsolationMVA3oldDMwoLT' )
       var(ttr, 'tau_byVVTightIsolationMVA3oldDMwoLT')

       var(ttr, 'tau_byIsolationMVA3oldDMwLTraw'     )
       var(ttr, 'tau_byLooseIsolationMVA3oldDMwLT'   )
       var(ttr, 'tau_byMediumIsolationMVA3oldDMwLT'  )
       var(ttr, 'tau_byTightIsolationMVA3oldDMwLT'   )
       var(ttr, 'tau_byVTightIsolationMVA3oldDMwLT'  )
       var(ttr, 'tau_byVVTightIsolationMVA3oldDMwLT' )

       var(ttr, 'tau_byIsolationMVA3newDMwoLTraw'    )
       var(ttr, 'tau_byLooseIsolationMVA3newDMwoLT'  )
       var(ttr, 'tau_byMediumIsolationMVA3newDMwoLT' )
       var(ttr, 'tau_byTightIsolationMVA3newDMwoLT'  )
       var(ttr, 'tau_byVTightIsolationMVA3newDMwoLT' )
       var(ttr, 'tau_byVVTightIsolationMVA3newDMwoLT')

       var(ttr, 'tau_byIsolationMVA3newDMwLTraw'     )
       var(ttr, 'tau_byLooseIsolationMVA3newDMwLT'   )
       var(ttr, 'tau_byMediumIsolationMVA3newDMwLT'  )
       var(ttr, 'tau_byTightIsolationMVA3newDMwLT'   )
       var(ttr, 'tau_byVTightIsolationMVA3newDMwLT'  )
       var(ttr, 'tau_byVVTightIsolationMVA3newDMwLT' )

       var(ttr, 'tau_againstMuonLoose3'   )
       var(ttr, 'tau_againstMuonTight3'   )
       var(ttr, 'tau_againstMuonMVALoose' )
       var(ttr, 'tau_againstMuonMVAMedium')
       var(ttr, 'tau_againstMuonMVATight' )

       var(ttr, 'tau_againstElectronLoose'     )
       var(ttr, 'tau_againstElectronMedium'    )
       var(ttr, 'tau_againstElectronTight'     )
       var(ttr, 'tau_againstElectronLooseMVA5' )
       var(ttr, 'tau_againstElectronMediumMVA5')
       var(ttr, 'tau_againstElectronTightMVA5' )
       var(ttr, 'tau_againstElectronVTightMVA5')
...
#           fill(ttr, 'tau_againstE0Cat', it.againstE0Cat)
       ...
       ## RM new TauIDs
           fill(ttr, 'tau_byIsolationMVA3oldDMwoLTraw'    , it.byIsolationMVA3oldDMwoLTraw    )
           fill(ttr, 'tau_byLooseIsolationMVA3oldDMwoLT'  , it.byLooseIsolationMVA3oldDMwoLT  )
           fill(ttr, 'tau_byMediumIsolationMVA3oldDMwoLT' , it.byMediumIsolationMVA3oldDMwoLT )
           fill(ttr, 'tau_byTightIsolationMVA3oldDMwoLT'  , it.byTightIsolationMVA3oldDMwoLT  )
           fill(ttr, 'tau_byVTightIsolationMVA3oldDMwoLT' , it.byVTightIsolationMVA3oldDMwoLT )
           fill(ttr, 'tau_byVVTightIsolationMVA3oldDMwoLT', it.byVVTightIsolationMVA3oldDMwoLT)

           fill(ttr, 'tau_byIsolationMVA3oldDMwLTraw'     , it.byIsolationMVA3oldDMwLTraw     )
           fill(ttr, 'tau_byLooseIsolationMVA3oldDMwLT'   , it.byLooseIsolationMVA3oldDMwLT   )
           fill(ttr, 'tau_byMediumIsolationMVA3oldDMwLT'  , it.byMediumIsolationMVA3oldDMwLT  )
           fill(ttr, 'tau_byTightIsolationMVA3oldDMwLT'   , it.byTightIsolationMVA3oldDMwLT   )
           fill(ttr, 'tau_byVTightIsolationMVA3oldDMwLT'  , it.byVTightIsolationMVA3oldDMwLT  )
           fill(ttr, 'tau_byVVTightIsolationMVA3oldDMwLT' , it.byVVTightIsolationMVA3oldDMwLT )

           fill(ttr, 'tau_byIsolationMVA3newDMwoLTraw'    , it.byIsolationMVA3newDMwoLTraw    )
           fill(ttr, 'tau_byLooseIsolationMVA3newDMwoLT'  , it.byLooseIsolationMVA3newDMwoLT  )
           fill(ttr, 'tau_byMediumIsolationMVA3newDMwoLT' , it.byMediumIsolationMVA3newDMwoLT )
           fill(ttr, 'tau_byTightIsolationMVA3newDMwoLT'  , it.byTightIsolationMVA3newDMwoLT  )
           fill(ttr, 'tau_byVTightIsolationMVA3newDMwoLT' , it.byVTightIsolationMVA3newDMwoLT )
           fill(ttr, 'tau_byVVTightIsolationMVA3newDMwoLT', it.byVVTightIsolationMVA3newDMwoLT)

           fill(ttr, 'tau_byIsolationMVA3newDMwLTraw'     , it.byIsolationMVA3newDMwLTraw     )
           fill(ttr, 'tau_byLooseIsolationMVA3newDMwLT'   , it.byLooseIsolationMVA3newDMwLT   )
           fill(ttr, 'tau_byMediumIsolationMVA3newDMwLT'  , it.byMediumIsolationMVA3newDMwLT  )
           fill(ttr, 'tau_byTightIsolationMVA3newDMwLT'   , it.byTightIsolationMVA3newDMwLT   )
           fill(ttr, 'tau_byVTightIsolationMVA3newDMwLT'  , it.byVTightIsolationMVA3newDMwLT  )
           fill(ttr, 'tau_byVVTightIsolationMVA3newDMwLT' , it.byVVTightIsolationMVA3newDMwLT )

           fill(ttr, 'tau_againstMuonLoose3'   , it.againstMuonLoose3   )
           fill(ttr, 'tau_againstMuonTight3'   , it.againstMuonTight3   )
           fill(ttr, 'tau_againstMuonMVALoose' , it.againstMuonMVALoose )
           fill(ttr, 'tau_againstMuonMVAMedium', it.againstMuonMVAMedium)
           fill(ttr, 'tau_againstMuonMVATight' , it.againstMuonMVATight )

           fill(ttr, 'tau_againstElectronLoose'     , it.againstElectronLoose     )
           fill(ttr, 'tau_againstElectronMedium'    , it.againstElectronMedium    )
           fill(ttr, 'tau_againstElectronTight'     , it.againstElectronTight     )
           fill(ttr, 'tau_againstElectronLooseMVA5' , it.againstElectronLooseMVA5 )
           fill(ttr, 'tau_againstElectronMediumMVA5', it.againstElectronMediumMVA5)
           fill(ttr, 'tau_againstElectronTightMVA5' , it.againstElectronTightMVA5 )
           fill(ttr, 'tau_againstElectronVTightMVA5', it.againstElectronVTightMVA5)
