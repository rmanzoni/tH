...
from CMGTools.H2TauTau.proto.analyzers.ScaleFactorsTauEle201253X import *
from CMGTools.RootTools.fwlite.AutoHandle import AutoHandle
from CMGTools.RootTools.utils.DeltaR import cleanObjectCollection, matchObjectCollection, bestMatch

class H2TauTauTreeProducerETT( TreeAnalyzerNumpyEMT ):
...
#       var(jtr, 'jet_phi')
    ...
    def declareHandles(self):
        super(H2TauTauTreeProducerETT, self).declareHandles()
...
#               trig_M17E8 = True
       ...
       for im in event.muoncand:
           ...
           fill(mtr, 'muon_trig_weight', 1.)
           fill(mtr, 'muon_id_weight', 1.)
       ...
       for ie in event.electroncand:
           ...
           fill(etr, 'electron_trig_weight', eleTrigScale_TauEle_2012_53X(ie.pt(), ie.eta()))
           fill(etr, 'electron_id_weight', eleIDscale_TauEle_2012_53X(ie.pt(), ie.eta()))
