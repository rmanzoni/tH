...
#        print 'Init for the WHEMTAnalyzer'
        super(WHEMTAnalyzer,self).__init__(cfg_ana, cfg_comp, looperName)


    # beginLoop
    def beginLoop(self):
#       print 'Init for the beginLoop'
        super(WHEMTAnalyzer, self).beginLoop()
        self.counters.addCounter('EMT')
        count = self.counters.counter('EMT')
    ...
    def declareHandles(self):
        super(WHEMTAnalyzer, self).declareHandles()
    ...
    def buildLooseTau(self, cmgLeptons, event):
        ...
        for index, lep in enumerate(cmgLeptons):
            ...
            ## RM is the following really really needed?
#             pyl.flag_id            = False
#             pyl.flag_iso           = False
#             pyl.decaymode          = -999
#             pyl.ep                 = -999
...
#             pyl.byLooseIsolationMVA3oldDMwoLT   = -999
#             pyl.byMediumIsolationMVA3oldDMwoLT  = -999
#             pyl.byTightIsolationMVA3oldDMwoLT   = -999
#             pyl.byVTightIsolationMVA3oldDMwoLT  = -999
#             pyl.byVVTightIsolationMVA3oldDMwoLT = -999
#
#             pyl.byIsolationMVA3oldDMwLTraw      = -999
#             pyl.byLooseIsolationMVA3oldDMwLT    = -999
#             pyl.byMediumIsolationMVA3oldDMwLT   = -999
#             pyl.byTightIsolationMVA3oldDMwLT    = -999
#             pyl.byVTightIsolationMVA3oldDMwLT   = -999
#             pyl.byVVTightIsolationMVA3oldDMwLT  = -999
#
#             pyl.byIsolationMVA3newDMwoLTraw     = -999
#             pyl.byLooseIsolationMVA3newDMwoLT   = -999
#             pyl.byMediumIsolationMVA3newDMwoLT  = -999
#             pyl.byTightIsolationMVA3newDMwoLT   = -999
#             pyl.byVTightIsolationMVA3newDMwoLT  = -999
#             pyl.byVVTightIsolationMVA3newDMwoLT = -999
#
#             pyl.byIsolationMVA3newDMwLTraw      = -999
#             pyl.byLooseIsolationMVA3newDMwLT    = -999
#             pyl.byMediumIsolationMVA3newDMwLT   = -999
#             pyl.byTightIsolationMVA3newDMwLT    = -999
#             pyl.byVTightIsolationMVA3newDMwLT   = -999
#             pyl.byVVTightIsolationMVA3newDMwLT  = -999
#             ## antimuon
#             pyl.againstMuonLoose3    = -999
#             pyl.againstMuonTight3    = -999
#             pyl.againstMuonMVALoose  = -999
#             pyl.againstMuonMVAMedium = -999
#             pyl.againstMuonMVATight  = -999
#             ## antelectron
#             pyl.againstElectronLoose      = -999
#             pyl.againstElectronMedium     = -999
#             pyl.againstElectronTight      = -999
#             pyl.againstElectronLooseMVA5  = -999
#             pyl.againstElectronMediumMVA5 = -999
#             pyl.againstElectronTightMVA5  = -999
#             pyl.againstElectronVTightMVA5 = -999
...
#         if pyl.tauID("againstMuonLoose") > 0.5 and pyl.tauID("againstElectronLooseMVA3"):
        if pyl.tauID("againstMuonMVALoose") > 0.5 and pyl.tauID("againstElectronLooseMVA5"):
