...
#connect(mc_diboson, '%ETauTau_Yuta_Mar11', 'cmgTuple_.*root', aliases, cache=True, verbose=False)
#connect(t_mc_ewk, '%ETauTau_Yuta_Mar11', 'cmgTuple_.*root', aliases, cache=True, verbose=False)
#connect(mc_dy, '%ETauTau_Yuta_Mar11', 'cmgTuple_.*root', aliases, cache=True, verbose=False)
#connect(mc_w, '%ETauTau_Yuta_Mar11', 'cmgTuple_.*root', aliases, cache=True, verbose=False)
#connect(data_list, '%ETauTau_Yuta_Mar11', 'cmgTuple_.*root', aliases, cache=True, verbose=False)
connect(mc_tH, '%ETauTau_Yuta_Mar11', 'cmgTuple_.*root', aliases, cache=True, verbose=False)
