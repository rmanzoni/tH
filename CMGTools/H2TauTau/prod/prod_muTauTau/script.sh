...
ProductionTasks.py -w '*.root' -c -N 5 -q 1nd -t MuTauTau_Yuta_Feb28 --batch_user htautau_group --output_wildcard '*.root' --cfg skim_mutautau_cfg.py `cat samples_skim.txt`
