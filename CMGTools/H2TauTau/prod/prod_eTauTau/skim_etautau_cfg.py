...
dataset_files = 'cmgTuple_etautau_skimmed.*root'
...
process.cmgMuonSel.cut = ('pt() > 24 && abs(eta()) < 2.1')
...
process.cmgElectronSel.cut = ('pt() > 20 && abs(eta()) < 2.1')
process.cmgElectronCount.minNumber = 1


process.cmgTauSel.src = 'cmgTauSel'
process.cmgTauSel.cut = ('pt() > 20 && abs(eta()) < 2.3 && tauID("decayModeFinding") && tauID("againstMuonTight")')
#process.cmgTauSel.cut = ('pt() > 20 && abs(eta()) < 2.5 && tauID("decayModeFinding")')
process.cmgTauCount.minNumber = 2
